...
namespace PrivacyMonitor
{
    ...
    public static class ProtectionEngine
    {
        ...
        private static List<BlocklistEntry> GetDefaultBlocklistEntries()
        {
            ...
            // ─── Redirect gateways / affiliate cloaking ───
            new BlocklistEntry { Domain = "redirectingat.com", Label = "Redirect Gateway", Category = "Ad" },
            new BlocklistEntry { Domain = "go.redirectingat.com", Label = "Redirect Gateway", Category = "Ad" },
            new BlocklistEntry { Domain = "viglink.com", Label = "VigLink", Category = "Ad" },
            new BlocklistEntry { Domain = "skimlinks.com", Label = "Skimlinks", Category = "Ad" },
            new BlocklistEntry { Domain = "skimresources.com", Label = "Skimresources", Category = "Ad" },
            new BlocklistEntry { Domain = "link.media", Label = "Link Media", Category = "Ad" },
            // ─── Push ads / aggressive ad networks ───
            new BlocklistEntry { Domain = "propellerads.com", Label = "PropellerAds", Category = "Ad" },
            new BlocklistEntry { Domain = "popads.net", Label = "PopAds", Category = "Ad" },
            new BlocklistEntry { Domain = "popcash.net", Label = "PopCash", Category = "Ad" },
            new BlocklistEntry { Domain = "adsterra.com", Label = "Adsterra", Category = "Ad" },
            new BlocklistEntry { Domain = "exoclick.com", Label = "ExoClick", Category = "Ad" },
            new BlocklistEntry { Domain = "trafficjunky.com", Label = "TrafficJunky", Category = "Ad" },
            new BlocklistEntry { Domain = "clickadu.com", Label = "ClickAdu", Category = "Ad" },
            new BlocklistEntry { Domain = "hilltopads.net", Label = "HilltopAds", Category = "Ad" },
            new BlocklistEntry { Domain = "adskeeper.com", Label = "AdsKeeper", Category = "Ad" },
            new BlocklistEntry { Domain = "popmyads.com", Label = "PopMyAds", Category = "Ad" },
            new BlocklistEntry { Domain = "onclkds.com", Label = "OnClick", Category = "Ad" },
            new BlocklistEntry { Domain = "content.ad", Label = "Content.ad", Category = "Ad" },
            new BlocklistEntry { Domain = "mgid.io", Label = "MGID", Category = "Ad" },
            new BlocklistEntry { Domain = "revcontent.io", Label = "Revcontent", Category = "Ad" },
            new BlocklistEntry { Domain = "taboolasyndication.com", Label = "Taboola Syndication", Category = "Ad" },
            new BlocklistEntry { Domain = "pushcrew.com", Label = "PushCrew", Category = "Ad" },
            new BlocklistEntry { Domain = "onesignal.com", Label = "OneSignal", Category = "Tracking" },
            new BlocklistEntry { Domain = "izooto.com", Label = "iZooto", Category = "Ad" },
            new BlocklistEntry { Domain = "webpushr.com", Label = "WebPushr", Category = "Ad" },
            new BlocklistEntry { Domain = "aimtell.com", Label = "Aimtell", Category = "Ad" },
            new BlocklistEntry { Domain = "push.advertising.com", Label = "Verizon Push", Category = "Ad" },
            // ─── More ad tech / SSPs / tracking ───
            new BlocklistEntry { Domain = "stats.g.doubleclick.net", Label = "DoubleClick Stats", Category = "Tracking" },
            new BlocklistEntry { Domain = "fundingchoices.google.com", Label = "Google Funding Choices", Category = "Ad" },
            new BlocklistEntry { Domain = "www.clarity.ms", Label = "Clarity", Category = "Tracking" },
            new BlocklistEntry { Domain = "c.clarity.ms", Label = "Clarity", Category = "Tracking" },
            new BlocklistEntry { Domain = "ads.tiktok.com", Label = "TikTok Ads", Category = "Ad" },
            new BlocklistEntry { Domain = "business-api.tiktok.com", Label = "TikTok Business API", Category = "Tracking" },
            new BlocklistEntry { Domain = "px4.ads.linkedin.com", Label = "LinkedIn Ads", Category = "Ad" },
            new BlocklistEntry { Domain = "dpm.demdex.net", Label = "Adobe DPM", Category = "Tracking" },
            new BlocklistEntry { Domain = "cm.everesttech.net", Label = "Adobe Everest", Category = "Tracking" },
            new BlocklistEntry { Domain = "pixel.quantserve.com", Label = "Quantcast Pixel", Category = "Tracking" },
            new BlocklistEntry { Domain = "edge.quantserve.com", Label = "Quantcast Edge", Category = "Tracking" },
            new BlocklistEntry { Domain = "cdn.segment.com", Label = "Segment CDN", Category = "Tracking" },
            new BlocklistEntry { Domain = "cdn.amplitude.com", Label = "Amplitude CDN", Category = "Tracking" },
            new BlocklistEntry { Domain = "cdn.heapanalytics.com", Label = "Heap CDN", Category = "Tracking" },
            new BlocklistEntry { Domain = "cdn.hotjar.com", Label = "Hotjar CDN", Category = "Tracking" },
            new BlocklistEntry { Domain = "static.hotjar.com", Label = "Hotjar Static", Category = "Tracking" },
            new BlocklistEntry { Domain = "script.hotjar.com", Label = "Hotjar Script", Category = "Tracking" },
            new BlocklistEntry { Domain = "ads.reddit.com", Label = "Reddit Ads", Category = "Ad" },
            new BlocklistEntry { Domain = "events.redditmedia.com", Label = "Reddit Events", Category = "Tracking" },
            new BlocklistEntry { Domain = "cdn.braze.com", Label = "Braze CDN", Category = "Tracking" },
            new BlocklistEntry { Domain = "clevertap.com", Label = "CleverTap", Category = "Tracking" },
            new BlocklistEntry { Domain = "zeotap.io", Label = "Zeotap", Category = "Tracking" },
            new BlocklistEntry { Domain = "rudderstack.com", Label = "RudderStack", Category = "Tracking" },
            new BlocklistEntry { Domain = "rs.rudderstack.com", Label = "RudderStack", Category = "Tracking" },
            new BlocklistEntry { Domain = "posthog.com", Label = "PostHog", Category = "Tracking" },
            new BlocklistEntry { Domain = "us.posthog.com", Label = "PostHog", Category = "Tracking" },
            new BlocklistEntry { Domain = "launchdarkly.com", Label = "LaunchDarkly", Category = "Tracking" },
            new BlocklistEntry { Domain = "cdn.launchdarkly.com", Label = "LaunchDarkly CDN", Category = "Tracking" },
            new BlocklistEntry { Domain = "consensu.org", Label = "Consent API", Category = "Tracking" },
            new BlocklistEntry { Domain = "sourcepoint.com", Label = "Sourcepoint", Category = "Tracking" },
            new BlocklistEntry { Domain = "didomi.io", Label = "Didomi", Category = "Tracking" },
            new BlocklistEntry { Domain = "quantcast.com", Label = "Quantcast", Category = "Tracking" },
            new BlocklistEntry { Domain = "zendesk.com", Label = "Zendesk", Category = "Tracking" },
            new BlocklistEntry { Domain = "zdassets.com", Label = "Zendesk Assets", Category = "Tracking" },
            new BlocklistEntry { Domain = "plausible.io", Label = "Plausible", Category = "Tracking" },
            new BlocklistEntry { Domain = "matomo.cloud", Label = "Matomo Cloud", Category = "Tracking" },
            new BlocklistEntry { Domain = "cdn.onesignal.com", Label = "OneSignal CDN", Category = "Tracking" },
            new BlocklistEntry { Domain = "log.optimizely.com", Label = "Optimizely Log", Category = "Tracking" },
            new BlocklistEntry { Domain = "www.googletagmanager.com", Label = "GTM", Category = "Tracking" },
            new BlocklistEntry { Domain = "idsync.rlcdn.com", Label = "LiveRamp ID Sync", Category = "Tracking" },
            new BlocklistEntry { Domain = "sitescout.com", Label = "SiteScout", Category = "Ad" },
            new BlocklistEntry { Domain = "nextroll.com", Label = "NextRoll", Category = "Ad" },
            new BlocklistEntry { Domain = "smartyads.com", Label = "SmartyAds", Category = "Ad" },
            new BlocklistEntry { Domain = "e-planning.net", Label = "ePlanning", Category = "Ad" },
            new BlocklistEntry { Domain = "widespace.com", Label = "Widespace", Category = "Ad" },
            new BlocklistEntry { Domain = "connextra.com", Label = "Connextra", Category = "Ad" },
            new BlocklistEntry { Domain = "contentrecommendation.net", Label = "Content Recommendation", Category = "Ad" },
            new BlocklistEntry { Domain = "bidtellect.com", Label = "Bidtellect", Category = "Ad" },
            new BlocklistEntry { Domain = "zemanta.com", Label = "Zemanta", Category = "Ad" },
            new BlocklistEntry { Domain = "connatix.com", Label = "Connatix", Category = "Ad" },
            new BlocklistEntry { Domain = "synacor.com", Label = "Synacor", Category = "Ad" },
            new BlocklistEntry { Domain = "audiencescience.com", Label = "AudienceScience", Category = "Tracking" },
            new BlocklistEntry { Domain = "firebase-settings.crashlytics.com", Label = "Crashlytics", Category = "Tracking" },
            new BlocklistEntry { Domain = "pub.doubleverify.com", Label = "DoubleVerify", Category = "Ad" },
            new BlocklistEntry { Domain = "leadbolt.net", Label = "Leadbolt", Category = "Ad" },
            new BlocklistEntry { Domain = "wizrocket.com", Label = "WizRocket", Category = "Tracking" },
            new BlocklistEntry { Domain = "tracking.leadlander.com", Label = "LeadLander", Category = "Tracking" },
            new BlocklistEntry { Domain = "tracking.parsely.com", Label = "Parse.ly Tracking", Category = "Tracking" },
            new BlocklistEntry { Domain = "acceptableads.com", Label = "Acceptable Ads", Category = "Ad" },
            new BlocklistEntry { Domain = "blockadblock.com", Label = "Block AdBlock", Category = "Ad" },
